 ...
 */
class GFExcel_VendorHTMLPurifier_Injector_Linkify extends GFExcel_VendorHTMLPurifier_Injector
{
    /**
     * @type string
     */
    ...
    public function handleText(&$token)
    {
        ...
        for ($i = 0, $c = count($bits), $l = false; $i < $c; $i++, $l = !$l) {
            if (!$l) {
                ...
                $token[] = new GFExcel_VendorHTMLPurifier_Token_Start('a', array('href' => $bits[$i]));
                $token[] = new GFExcel_VendorHTMLPurifier_Token_Text($bits[$i]);
